...
from caner.cluster_pipeline import get_cluster_list
...
class TestCaner(unittest.TestCase):
    ...
    def test_train(self):
        ...
        config = NetConfig(vec_type='word2vec', vec_path='/Users/chenyuanzhe/Desktop/wiki_cha_embedding.txt',
                           label_list=self.label_list, seq_length=10, batch_size=2, embedding_size=100, unit_num=64,
                           iter_num=10, train_type='caner', feature_extractor='transformer',
                           cluster_csv_list=[ORG_A_CSV])
